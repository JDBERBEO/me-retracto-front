  ...
  return (
    <>
      ...
      <div
        ...
        {adminError || lawyerError ? (
          <span className="form-label">Usuario o contraseña incorrecta*</span>
        ) : null}
        <form
          style={{
            backgroundColor: '#00AC9E',
          ...
          <section
            ...
            <input
              ...
              name="email"
              type="text"
              placeholder="Escribe aqui el nombre de usuario registrado"
            />
          ...
          <section
            ...
            <Select
              {...register('userType')}
              onChange={(option) => setValue('userType', option?.value, { shouldValidate: true })}
              components={{
                Option: customOption,
                NoOptionsMessage
              }}
