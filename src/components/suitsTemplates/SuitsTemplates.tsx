...
export const SuitsTemplates = () => {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      width: 400,
      renderCell: (params) => {
        return <div className="stepNumberContainer">
        <div className='iconBorder'>
          <button className='iconBorder__icon' style={{backgroundColor: 'transparent', border:'none'}} onClick={() => handleOnClick(params.row.id)}><RiDeleteBin6Line /></button>
        </div>
      </div>  
      }
    },
  ...
  return (
    ...
    >
      ...
      <Link to='/templateForm'>
        <button className='outlinedButton__red'>
