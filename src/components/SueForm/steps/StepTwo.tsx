...
export const StepTwo = ({  
  ...
  sendEmail
    ...
    const schema = object({
      acceptTerms: boolean().oneOf([true],'Para continuar debes aceptar la política de tratamiento de datos*')
    })
  ...
  return (
    ...
    <section style={{display:'flex', flexDirection: 'column', alignItems: 'center'}}>
      ...
      <Col sm={4}>
        <section style={{display:'flex', flexDirection: 'column', alignItems: 'center', justifyContent:'start', marginTop: '20px', marginBottom: '20px', height: '81px'}}>
          <div style={{display:'flex', flexDirection: 'row', alignItems: 'center', justifyContent:'center'}}>
            <input {...register('acceptTerms')}  type="checkbox" style={{fontFamily: 'Raleway, sans-serif',  textAlign: 'center', fontWeight: 700, fontSize: '11px', letterSpacing: '1px', color: 'white'}} />
            <label style={{fontFamily: 'Raleway, sans-serif',  textAlign: 'center', fontWeight: 700, fontSize: '11px', letterSpacing: '1px', color: 'white'}}>AUTORIZO EL TRATAMIENTO DE DATOS PERSONALES *</label>
          </div>
          <div>
            <span style={{fontFamily: 'Raleway, sans-serif',  textAlign: 'center', fontWeight: 700, fontSize: '11px', letterSpacing: '1px', color: 'white', marginTop: '7vh', marginBottom: '8vh',}}>{errors?.acceptTerms?.message}</span>
          </div>
        </section>
      </Col>
    </section>
